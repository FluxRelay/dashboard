...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [FluxRelay](https://github.com/FluxRelay) open-source ecosystem.
...
The `dashboard` application is the web frontend for FluxRelay, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/FluxRelay/dashboard
cd dashboard
npm install
```
